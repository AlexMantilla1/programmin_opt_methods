...
def calculate_new_D_matrix_BFGS(D_matrix: npt.ArrayLike, p_j: npt.ArrayLike, q_j: npt.ArrayLike) -> npt.ArrayLike:
    """
...
def main() -> None:
    ...
    solution: Dict = broyden_fletcher_goldfarb_shanno(epsilon, initial_point, fun)
    # Just print solution
